...
import type { SkillData } from "@/hooks/usePortfolioContent";

const iconMap: Record<string, typeof Globe> = {
  "Languages": Globe, "MS Office": FileText, "Team Leadership": Users,
  "Collaboration": Handshake, "Mobile Photography": Camera,
};
